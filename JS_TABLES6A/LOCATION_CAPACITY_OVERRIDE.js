// LOCATION_CAPACITY_OVERRIDE.js

window.LOCATION_CAPACITY_OVERRIDE = {
  "tables": {
    "LOCATION_CAPACITY_OVERRIDE": {
      "columns": {
        "LOCATION_CAPACITY_GID": {
          ...
          "nullable": false,
          "key_value": true,
          "foreign_key": "LOCATION_CAPACITY_D"
        },
        "ACTIVITY_CALENDAR_GID": {
          "type": "NUMBER()",
          "nullable": false,
          "key_value": true,
          "foreign_key": "ACTIVITY_CALENDAR"
        },
        "CAPACITY_TYPE": {
          "type": "VARCHAR2(101)",
          "nullable": false,
        ...
        "ACTIVITY_GID": {
          ...
          "nullable": false,
          "foreign_key": "LOCATION_CAPACITY_D",
          "info": "The sole purpose of this column is to make FK to LOCATION_CAPACITY_D.  It should match the ACTIVITY_GID of ACTIVITY_CALENDAR. "
        },
