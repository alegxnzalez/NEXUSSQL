// S_SHIP_UNIT_REFNUM_QUAL.js

window.S_SHIP_UNIT_REFNUM_QUAL = {
  "tables": {
    "S_SHIP_UNIT_REFNUM_QUAL": {
      "columns": {
        "S_SHIP_UNIT_REFNUM_QUAL_GID": {
          ...
          "nullable": false,
          "key_value": true,
          "info": "Internal reference qualifier comprised of domain concatenated with the xid. "
        },
        "S_SHIP_UNIT_REFNUM_QUAL_XID": {
          "type": "VARCHAR2(50)",
          "nullable": false,
          "info": "External reference qualifier. "
        },
        "S_SHIP_UNIT_REFNUM_QUAL_DESC": {
          "type": "VARCHAR2(120)",
          "nullable": true,
          "info": "Description. "
        },
