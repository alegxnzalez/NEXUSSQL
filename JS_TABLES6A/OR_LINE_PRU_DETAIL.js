// OR_LINE_PRU_DETAIL.js

window.OR_LINE_PRU_DETAIL = {
  "tables": {
    "OR_LINE_PRU_DETAIL": {
      "columns": {
        "DOMAIN_NAME": {
        ...
        "PACKAGING_REFERENCE_UNIT_GID": {
          ...
          "info": "The packaging reference unit GID. The package reference unit (PRU) defines another dimension to describe the consumption and capacity associated to building the order release ship units for transport. An example could be value of goods, loading meters, etc. "
        },
        "UNIT_PRU_COUNT": {
          "type": "NUMBER()",
          "nullable": true,
