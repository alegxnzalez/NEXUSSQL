  ...
  "tables": {
    "OB_REFNUM_QUAL": {
      "columns": {
        ...
        "OB_REFNUM_SEQUENCE_NO": {
          "type": "NUMBER(10)",
          "nullable": true,
          "info": "The sequence number for Refnum Qualifier, to determine the sequence of Refnum Qualifiers on the Order Base Manager."
        },
        "DOMAIN_NAME": {
          "type": "VARCHAR2(50)",
          "nullable": false
