    ...
    "LOCATION_ROLE_PROFILE": {
      "columns": {
        ...
        "CREATE_XDOCK_HANDLING_SHIPMENT": {
          ...
          "info": "Using the Create Crossdock Handling Shipment field creates handling shipments as part of the cross-dock building process. Clear the check box to bulk plan cross-docks without handling shipments.\nFixed Handling Time: Same as above.\nThe Variable Handling Time and the Variable Handling Weight: Same as above.\nMax Freight Idle Time: Same as above. "
        },
