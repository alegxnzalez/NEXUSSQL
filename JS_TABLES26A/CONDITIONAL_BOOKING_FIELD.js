...
window.CONDITIONAL_BOOKING_FIELD = {
  "tables": {
    "CONDITIONAL_BOOKING_FIELD": {
      "description": "static data for conditional booking field specification",
      "columns": {
        ...
        "UPDATE_FIELD_NAME": {
          "type": "VARCHAR2(500)",
          "nullable": true,
          "info": "this column capture the names of update field.  The convention is <TABLE_NAME>.<COLUMN_NAME>, i.e., SHIPMENT.TOTAL_VOLUME.  Multiple values separated by comma are allowed."
},
        "DOMAIN_NAME": {
          "type": "VARCHAR2(50)",
          "nullable": false
