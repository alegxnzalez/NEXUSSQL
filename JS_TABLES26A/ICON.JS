...
window.ICON = {
  "tables": {
    "ICON": {
      "description": "This table can store both custom and baseline icons,  which can be used  within GC3.",
      "columns": {
        "ICON_GID": {
          "type": "VARCHAR2(101)",
          "nullable": false,
        ...
        "SPRITE_IMG": {
          "type": "VARCHAR2(101)",
          "nullable": true,
          "info": "this is the sprite image name with path which contains this icon."
},
        "SPRITE_POSITION": {
          "type": "VARCHAR2(50)",
          "nullable": true,
          "info": "The position this icon is at on the sprite image."
}
      },
      "fk_tables": [
        "CHARTER_VOYAGE",
