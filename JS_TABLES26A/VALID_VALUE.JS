...
window.VALID_VALUE = {
  "tables": {
    "VALID_VALUE": {
      "description": "Holds all valid values to be used for the type described in VALID_VALUE_TYPE",
      "columns": {
        "VALID_VALUE_TYPE_GID": {
          ...
          "info": "Identifies type from the VALID_VALUE_TYPE table that is associated with the value for this record"
},
        "VALUE": {
          "type": "VARCHAR2(101)",
          "nullable": false,
