    ...
    "REPETITION_SCHEDULE": {
      "columns": {
        ...
        "IS_INVOKE_CONOPT": {
          ...
          "info": "This field is only used for ground schedules during planning. When it is set to true, conopt logic will be used to pack the equipment for this ground schedule during planning."
}
      },
      "fk_tables": [
        "GROUND_REFNUM",
