...
window.SERVPROV = {
  "tables": {
    "SERVPROV": {
      "description": "This table stores the information about the service providers.",
      "columns": {
        "SERVPROV_GID": {
          "type": "VARCHAR2(101)",
          "nullable": false,
        ...
        "IS_ACTIVE": {
          ...
          "info": "This flag will define whether service provider is active or not.By default this flag will be Y."
},
        "SG_TENDER_OUT_XML_PROFILE_GID": {
          "type": "VARCHAR2(101)",
          "nullable": true,
          "foreign_key": "OUT_XML_PROFILE",
          "info": "Associates the service provider with an out_xml_profile, which helps define the content of outgoing ship group tender XML to this service provider."
},
        "ALLOW_SG_TENDER": {
          "type": "VARCHAR2(1)",
          "nullable": false,
          ...
          "info": "Ship group allow tender determines whether the system can automatically tender  ship group to this service provider.By default it is set to 'N'"
}
      },
      "fk_tables": [
