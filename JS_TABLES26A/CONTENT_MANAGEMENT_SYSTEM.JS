...
window.CONTENT_MANAGEMENT_SYSTEM = {
  "tables": {
    "CONTENT_MANAGEMENT_SYSTEM": {
      "description": "Content Management System for document integration",
      "columns": {
        "DOMAIN_NAME": {
          "type": "VARCHAR2(50)",
          "nullable": false
        ...
        "EXTERNAL_SYSTEM_GID": {
          ...
          "info": "External System ID providing the connection details to Content Management System. For example, For connecting with Microsoft Graph API using OAuth authorization."
},
        "DRIVE_ID": {
          "type": "VARCHAR2(128)",
          "nullable": true,
          "info": "Drive ID for accessing the document library of a user (OneDrive), Group, or SharePoint Site for SharePoint Online using Microsoft Graph API."
}
      },
      "fk_tables": [
        "CMS_PARAM",
