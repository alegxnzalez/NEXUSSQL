...
window.OR_STOP = {
  "tables": {
    "OR_STOP": {
      "description": "This table defines intermediate stops on an order.",
      "columns": {
        "OR_STOP_GID": {
          "type": "VARCHAR2(101)",
          "nullable": false,
        ...
        "LATE_ARRIVAL_TIME": {
          "type": "DATE",
          "nullable": true,
          "info": "The late arrival date and time for the stop, and when IS_APPT is Y, this field is late appointment time."
},
        "IS_APPT": {
          "type": "VARCHAR2(1)",
          "nullable": false,
