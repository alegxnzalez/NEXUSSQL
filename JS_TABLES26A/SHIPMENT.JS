...
window.SHIPMENT = {
  "tables": {
    "SHIPMENT": {
      "description": "Table (and associated tables of SHIPMENT_STOP, SHIPMENT_STOP_D, S_SHIP_UNIT_LINE, and S_SHIP_UNIT) was added in 2.5 to indicate what was actually shipped.  This module was added because in 2.1 if the quantity received was different than what was requested, the ORDER_RELEASE information got overwritten.  There was no way of comparing how accurate the actual shipments were to what was requested.  These tables look very similar to the tables associated with ORDER_RELEASE. The key to this table is SHIPMENT_GID, because there is one record for every actual shipment in this table.",
      "columns": {
        "SHIPMENT_GID": {
          "type": "VARCHAR2(101)",
          "nullable": false,
        ...
        "PORT_OF_EXIT_DATE": {
          "type": "DATE",
          "nullable": true,
          "info": "The estimated port of exit (for international shipments) associated with ocean going shipments."
},
        "PORT_EXIT_LOC_GID": {
          "type": "VARCHAR2(101)",
          "nullable": true,
        ...
        "MAX_NUM_RETENDER": {
          "type": "NUMBER(6)",
          "nullable": true,
          "info": "Maximum number of re-tenders."
},
        "ATTRIBUTE_NUMBER11": {
          "type": "NUMBER",
          "nullable": true,
        ...
        "RESERVATION_NUM": {
          "type": "VARCHAR2(50)",
          "nullable": true,
          "info": "Saved here to search shipments based on Reservation Number."
},
        "IS_AR_ROUTE_CODE_FIXED": {
          "type": "VARCHAR2(1)",
          "nullable": false,
          "values": [
                    "Y",
          ...
          "info": "This flag is for rail route code on shipment to allow or restrict cost/rail route code updates."
},
        "WAYBILL_DATE": {
          "type": "DATE",
          "nullable": true,
          "info": "Waybill date represents contractual agreement of the carriage."
},
        "PROJECTED_TOUR_NAME": {
          "type": "VARCHAR2(101)",
          "nullable": true,
          "info": "Represents the identifier for the projected tour. If the projected tour is received as input, this is the supplied tour ID."
},
        "PROJECTED_TOUR_SEQUENCE_NUM": {
          "type": "NUMBER(5)",
          "nullable": true,
          "info": "Represents the sequence in which the shipment should appear in the projected tour."
},
        "EXTERNAL_VOYAGE_CODE": {
          "type": "VARCHAR2(80)",
          "nullable": true,
          "info": "Specifies the number of the voyage as assigned by the carrier that transports the shipment."
},
        "PLANNED_CO2_EMISSION": {
          "type": "NUMBER",
          "nullable": true,
          "info": "CO2 emissions recorded while planning the shipment."
},
        "PLANNED_CO2_EMISSION_UOM": {
          "type": "VARCHAR2(64)",
          "nullable": true,
          "info": "Unit of Measure for the planned CO2 emissions."
},
        "PLANNED_CO2_EMISSION_BASE": {
          "type": "NUMBER",
          "nullable": true,
          "info": "Planned CO2 emissions in base unit of measure."
},
        "ACTUAL_CO2_EMISSION": {
          "type": "NUMBER",
          "nullable": true,
          "info": "Actual CO2 emissions for the shipment."
},
        "ACTUAL_CO2_EMISSION_UOM": {
          "type": "VARCHAR2(64)",
          "nullable": true,
          "info": "Unit of Measure for the actual CO2 emissions."
},
        "ACTUAL_CO2_EMISSION_BASE": {
          "type": "NUMBER",
          "nullable": true,
          "info": "Actual CO2 emissions in base unit of measure."
},
        "PLANNED_CO2_EQ_EMISSION": {
          "type": "NUMBER",
          "nullable": true,
          "info": "CO2 equivalent emissions recorded while planning the shipment."
},
        "PLANNED_CO2_EQ_EMISSION_UOM": {
          "type": "VARCHAR2(64)",
          "nullable": true,
          "info": "Unit of Measure for the planned CO2 equivalent emissions."
},
        "PLANNED_CO2_EQ_EMISSION_BASE": {
          "type": "NUMBER",
          "nullable": true,
          "info": "Planned CO2 equivalent emissions in base unit of measure."
},
        "ACTUAL_CO2_EQ_EMISSION": {
          "type": "NUMBER",
          "nullable": true,
          "info": "Actual CO2 equivalent emissions for the shipment."
},
        "ACTUAL_CO2_EQ_EMISSION_UOM": {
          "type": "VARCHAR2(64)",
          "nullable": true,
          "info": "Unit of Measure for the actual CO2 equivalent emissions."
},
        "ACTUAL_CO2_EQ_EMISSION_BASE": {
          "type": "NUMBER",
          "nullable": true,
          "info": "Actual CO2 equivalent emissions in base unit of measure."
},
        "MARKET_COST": {
          "type": "NUMBER",
          "nullable": true,
        ...
        "LOADING_HALL_PENALTY": {
          "type": "NUMBER",
          "nullable": true,
          "info": "The loading hall penalty used while building loading halls for the shipment."
},
        "WORK_ASSIGNMENT_GID": {
          "type": "VARCHAR2(101)",
          "nullable": true,
          "foreign_key": "WORK_ASSIGNMENT",
          "info": "The ID of the Work Assignment of which the shipment is part of."
}
      },
      "fk_tables": [
        "ALLOCATION",
