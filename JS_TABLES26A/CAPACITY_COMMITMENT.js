...
window.CAPACITY_COMMITMENT = {
  "tables": {
    "CAPACITY_COMMITMENT": {
      "description": "Store a service provider's capacity commitment by  capacity group, equipment type, lane and time period",
      "columns": {
        ...
        "IS_COUNT_EXCLUSIVE": {
          ...
          "info": "Indicates that the shipments which count towards this Commitment Count will not count towards Commitment Allocation."
}
      },
      "fk_tables": [
        "COMMIT_DOW_OVERRIDE",
