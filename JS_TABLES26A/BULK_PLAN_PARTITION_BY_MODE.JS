// BULK_PLAN_PARTITION_BY_MODE.js

window.BULK_PLAN_PARTITION_BY_MODE = {
  "tables": {
    "BULK_PLAN_PARTITION_BY_MODE": {
      "description": "summary information of bulk plan partition break down by modes",
      "columns": {
        "BULK_PLAN_GID": {
          "type": "VARCHAR2(101)",
          "nullable": false,
          "key_value": true,
          "foreign_key": "BULK_PLAN_PARTITION"
},
        "PARTITION_GID": {
          "type": "VARCHAR2(101)",
          "nullable": false,
        ...
        "NUM_ORDERS_PLANNED": {
          "type": "NUMBER",
          "nullable": true,
          "info": "number of orders planned in this partition and this transport mode"
},
        "NUM_ORDER_MOVEMENTS_PLANNED": {
          "type": "NUMBER",
          "nullable": true,
          "info": "number of order movements planned in this partition and this transport mode"
},
        "TOTAL_COST": {
          "type": "NUMBER",
          "nullable": true,
          "info": "total cost of all shipments built in this partition and mode"
},
        ...
        "TOTAL_NUM_STOPS": {
          "type": "NUMBER",
          "nullable": true,
          "info": "average # of stops of all shipments in this partition and mode"
},
        "TOTAL_WEIGHT": {
          "type": "NUMBER",
          "nullable": true
