// SHIPMENT_ACCESSORIAL.js

window.SHIPMENT_ACCESSORIAL = {
  "tables": {
    "SHIPMENT_ACCESSORIAL": {
      "description": "This table stores the accessorials required for the shipment.",
      "columns": {
        "SHIPMENT_GID": {
          "type": "VARCHAR2(101)",
          "nullable": false,
        ...
        "ADJUSTMENT_REASON_GID": {
          ...
          "info": "The reason why the accessorial was added."
},
        "DOMAIN_NAME": {
          "type": "VARCHAR2(50)",
          "nullable": false,
