...
window.ACTION = {
  "tables": {
    "ACTION": {
      "description": "This table holds the list of all possible user interface actions that can be run in GC3.",
      "columns": {
        "ACTION_GID": {
          "type": "VARCHAR2(101)",
          "nullable": false,
        ...
        "RESULT_MESSAGE_TEXT": {
          "type": "VARCHAR2(128)",
          "nullable": true,
          "info": "Text of the action results message pop-up when there are no results available."
},
        "RESULT_AUTOCLOSE_TIMEOUT": {
          "type": "NUMBER",
          "nullable": true,
          "info": "Amount of time (in seconds) that the action results message pop-up remains open."
},
        "DEFAULT_LOG_PROFILE_GID": {
          "type": "VARCHAR2(101)",
          "nullable": true,
          "foreign_key": "LOG_PROFILE",
          "info": "Default log profile when action logging is enabled."
}
      },
      "fk_tables": [
        "ACTION_ARG",
