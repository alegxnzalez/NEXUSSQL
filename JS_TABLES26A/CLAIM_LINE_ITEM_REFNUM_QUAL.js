// CLAIM_LINE_ITEM_REFNUM_QUAL.js

window.CLAIM_LINE_ITEM_REFNUM_QUAL = {
  "tables": {
    "CLAIM_LINE_ITEM_REFNUM_QUAL": {
      "description": "Qualifiers for claim line item reference numbers",
      "columns": {
        "CLAIM_LI_REFNUM_QUAL_GID": {
          "type": "VARCHAR2(101)",
          "nullable": false,
          "key_value": true,
          "info": "Reference number qualifier gid"
},
        "CLAIM_LI_REFNUM_QUAL_XID": {
          "type": "VARCHAR2(50)",
          "nullable": false,
          "info": "Reference number qualifier xid"
},
        "DESCRIPTION": {
          "type": "VARCHAR2(120)",
          "nullable": true,
          "info": "Optional description for the reference number qualifier"
},
        "IS_VISIBLE_IF_MASTER_CARRIER": {
          "type": "VARCHAR2(1)",
          "nullable": false,
          "values": [
                    "Y",
