...
window.GL_USER = {
  "tables": {
    "GL_USER": {
      "description": "This table stores the GC3 users and their passwords. It also links to the USERS table to provide the U_NAME to get to Web Logic.",
      "columns": {
        "GL_USER_GID": {
          "type": "VARCHAR2(128)",
          "nullable": false,
        ...
        "IS_FEDERATED": {
          ...
          "info": "If Y, the user is considered a federated user."
},
        "IS_SYNC": {
          "type": "VARCHAR2(1)",
          "nullable": false,
          ...
          "info": "If Y, the user should be synchronized."
},
        "LAST_KNOWN_SYNC_DATE": {
          "type": "DATE",
          "nullable": true,
          "info": "The last known synchronization date."
}
      },
      "fk_tables": [
