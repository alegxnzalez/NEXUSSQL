...
window.APPT_RULE_SET = {
  "tables": {
    "APPT_RULE_SET": {
      "description": "This table used to add rules for appointments.It is used for both location resource and location resource group.",
      "columns": {
        "DOMAIN_NAME": {
          "type": "VARCHAR2(50)",
          "nullable": false,
        ...
        "MAXIMUM_SHIP_UNITS_ALLOWED": {
          "type": "NUMBER(10)",
          "nullable": true,
          "info": "The maximum ship units allowed."
},
        "APPT_CUTOFF_HOURS": {
          "type": "NUMBER",
          "nullable": true,
