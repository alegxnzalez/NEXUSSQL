...
window.ORDER_MOVEMENT = {
  "tables": {
    "ORDER_MOVEMENT": {
      "description": "Order movement represent part of the routing of an order. It is also a collection of ship units that are unplanned for certain part of a route.",
      "columns": {
        "ORDER_MOVEMENT_GID": {
          "type": "VARCHAR2(101)",
          "nullable": false,
        ...
        "DIRECT_DISTANCE": {
          "type": "NUMBER",
          "nullable": true,
          "info": "The distance from order movement source to its destination."
},
        "DIRECT_DISTANCE_BASE": {
          "type": "NUMBER",
          "nullable": true,
          "info": "The direct distance in base unit of measure."
},
        "DIRECT_DISTANCE_UOM_CODE": {
          "type": "VARCHAR2(101)",
          "nullable": true,
          "info": "The unit of measure for direct distance."
}
      },
      "fk_tables": [
