...
window.PERF_METRIC_TYPE = {
  "tables": {
    "PERF_METRIC_TYPE": {
      "description": "A common metric type for scalar metrics across a component. E.g., Backlog for Event Queues where the scalar metric is the Backlog for a specific Event Queue.",
      "columns": {
