// RATE_LOAD_TEMPLATE_RO_D.js

window.RATE_LOAD_TEMPLATE_RO_D = {
  "tables": {
    "RATE_LOAD_TEMPLATE_RO_D": {
      "columns": {
        ...
        "RATE_LOAD_TEMPLATE_RO_D_GID": {
          "type": "VARCHAR2(101)",
          "nullable": false,
          "key_value": true
},
        "RATE_LOAD_TEMPLATE_RO_D_XID": {
          "type": "VARCHAR2(50)",
          "nullable": false,
        ...
        "DISPLAY_NAME": {
          "type": "VARCHAR2(300)",
          "nullable": true,
          "info": "User defined name for the column."
},
        "TABLE_NAME": {
          "type": "VARCHAR2(50)",
          "nullable": true,
        ...
        "HIERARCHY": {
          "type": "VARCHAR2(50)",
          "nullable": false,
          "info": "Defines the dynamic hierarchy structure of rate offering structure display in rate load definition."
},
        "IS_MANDATORY": {
          "type": "VARCHAR2(1)",
          "nullable": false,
          ...
          "info": "Set to 'Y' for rate offering fields which are mandatory for creating Rate Load Definition."
},
        "IS_HEADER": {
          "type": "VARCHAR2(1)",
          "nullable": false,
