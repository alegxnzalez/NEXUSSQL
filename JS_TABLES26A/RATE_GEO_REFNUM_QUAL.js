// RATE_GEO_REFNUM_QUAL.js

window.RATE_GEO_REFNUM_QUAL = {
  "tables": {
    "RATE_GEO_REFNUM_QUAL": {
      "description": "Available qualifiers for rate geo reference numbers",
      "columns": {
        "RATE_GEO_REFNUM_QUAL_GID": {
          "type": "VARCHAR2(101)",
          "nullable": false,
          "key_value": true,
          "info": "Qualifier that may be used for a rate geo refnum"
},
        "RATE_GEO_REFNUM_QUAL_XID": {
          "type": "VARCHAR2(50)",
          "nullable": false,
          "info": "XID for qualifier that may be used for a rate geo refnum"
},
        "RATE_GEO_REFNUM_QUAL_DESC": {
          "type": "VARCHAR2(101)",
          "nullable": true,
          "info": "Description of this rate geo refnum qualifier"
},
        "DEFAULT_REFNUM_BN_TYPE_GID": {
          "type": "VARCHAR2(101)",
          "nullable": true,
          "foreign_key": "BN_TYPE",
          "info": "Business number generator bn type if this is to be created by the BNG"
},
        "UPDATE_FLAG": {
          "type": "VARCHAR2(13)",
          "nullable": true,
