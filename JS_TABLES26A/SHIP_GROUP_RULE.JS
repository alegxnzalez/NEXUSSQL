...
window.SHIP_GROUP_RULE = {
  "tables": {
    "SHIP_GROUP_RULE": {
      "description": "Rules that relate to the shipment group.",
      "columns": {
        "SHIP_GROUP_RULE_GID": {
          "type": "VARCHAR2(101)",
          "nullable": false,
        ...
        "SHIP_GROUP_MATCH_DATE_PERIOD": {
          ...
          "info": "Shipment Group rule criteria to create shipment groups by start time or to create the shipment groups for every day between shipment start and end time. For example, when the value is START DATE, two shipments with the same start time can go into one shipment group. When the value is DAILY, a shipment having the start and end date spanning two days, will create two shipment groups, one for day one and another for day two and the shipment will be part of both shipment groups.To create shipment group on monthly or weekly basis select MONTHLY or WEEKLY option."
},
        "FIRST_DAY_OF_WEEK": {
          "type": "VARCHAR2(101)",
          "nullable": true,
          ...
          "info": "Select the first day of the week. For example : MONDAY."
}
      },
      "fk_tables": [
        "SHIP_GROUP",
