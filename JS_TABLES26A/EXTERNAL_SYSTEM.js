    ...
    "EXTERNAL_SYSTEM": {
      "columns": {
        ...
        "AUTHENTICATION_TYPE": {
          ...
          "info": "HTTP authentication type. Valid Values are BASIC, PAR(Pre-Authenticated Request), OAUTH2(OAuth 2.0)"
},
        "PRE_AUTHENTICATED_URL": {
          "type": "VARCHAR2(1024)",
          "nullable": true,
          "info": "Pre-Authenticated Request(PAR) URL"
},
        "AUTH_SVC_AUTH_TYPE": {
          "type": "VARCHAR2(10)",
          "nullable": true,
          ...
          "info": "Authorization Service Authentication Type. This is the method used to request authorization from the authorization service on behalf of the client."
},
        "AUTH_SVC_URL": {
          "type": "VARCHAR2(1024)",
          "nullable": true,
          "info": "URL to call the authorization service."
},
        "APPL_SCOPE": {
          "type": "VARCHAR2(200)",
          "nullable": true,
          "info": "A blank delimited set of strings defined by the authorization service that limit the access scope for this client."
},
        "SIGNATURE_ALG": {
          "type": "VARCHAR2(20)",
          "nullable": true,
          "info": "Algorithm used to sign message if required by the authentication type."
},
        "CONTENT_TYPE": {
          "type": "VARCHAR2(500)",
          "nullable": false,
          "info": "Required content type for messages sent to this external system. Default value is 'text/xml'."
},
        "CONSUMER_KEY": {
          "type": "VARCHAR2(128)",
          "nullable": true,
          "info": "Key required by authentication service authentication type."
},
        "CONSUMER_SECRET": {
          "type": "VARCHAR2(128)",
          "nullable": true,
          "info": "Secret required by authentication service authentication type."
},
        "USE_HTTP_POST_OVERRIDE": {
          "type": "VARCHAR2(1)",
          "nullable": false,
          "values": [
                    "Y",
          ...
          "info": "Specifies if HTTP POST tunneling should be used."
},
        "HTTP_METHOD": {
          "type": "VARCHAR2(10)",
          "nullable": true,
          "info": "Specifies the HTTP method to be used."
},
        "HTTP_HEADER_PROFILE_GID": {
          "type": "VARCHAR2(101)",
          "nullable": true,
          "foreign_key": "HTTP_HEADER_PROFILE",
          "info": "A GID to specify the http_header_profile."
},
        "OTM_RELEASE": {
          "type": "VARCHAR2(101)",
          "nullable": true,
        ...
        "ALLOW_FOLLOW_REDIRECT": {
          ...
          "info": "Specifies if the External System should follow a redirect response message."
},
        "TRUST_CLIENT_ID": {
          "type": "VARCHAR2(1000)",
          "nullable": true,
          "info": "The client ID for the OAUTH confidential application."
},
        "TRUST_CLIENT_KID": {
          "type": "VARCHAR2(1000)",
          "nullable": true,
          "info": "The cryptographic key ID, identifying the key signing the OAUTH JWT request in the agentic confidential application."
},
        "TRUST_SIGN_PRIVATE_KEY": {
          "type": "VARCHAR2(16000)",
          "nullable": true,
          "info": "Private key to sign JWT token payloads. Must match public key registered with the confidential application."
},
        "TRUST_SIGN_ALGORITHM": {
          "type": "VARCHAR2(30)",
          "nullable": true,
          "values": [
                    "RS256",
        ...
        "TRUST_IDCS_URL": {
          "type": "VARCHAR2(255)",
          "nullable": true,
          "info": "IDCS URL for OAUTH token requests."
},
        "TRUST_AUDIENCE": {
          "type": "VARCHAR2(1000)",
          "nullable": true,
          "info": "Scope for OAUTH token requests."
},
        "TRUST_SCOPE": {
          "type": "VARCHAR2(1000)",
          "nullable": true,
          "info": "Scope of OAUTH token requests."
}
      },
      "fk_tables": [
        "CONTACT",
