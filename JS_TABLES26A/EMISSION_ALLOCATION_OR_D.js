// EMISSION_ALLOCATION_OR_D.js

window.EMISSION_ALLOCATION_OR_D = {
  "tables": {
    "EMISSION_ALLOCATION_OR_D": {
      "description": "This table stores the allocated emissions at order release level.",
      "columns": {
        "ALLOC_SEQ_NO": {
          "type": "NUMBER",
          "nullable": false,
        ...
        "ORDER_RELEASE_GID": {
          ...
          "info": "Order release ID for which emissions are allocated."
},
        "SHIPMENT_GID": {
          "type": "VARCHAR2(101)",
          "nullable": false,
