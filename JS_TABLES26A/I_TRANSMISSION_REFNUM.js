// I_TRANSMISSION_REFNUM.js

window.I_TRANSMISSION_REFNUM = {
  "tables": {
    "I_TRANSMISSION_REFNUM": {
      "description": "Transmission reference numbers.",
      "columns": {
        "I_TRANSMISSION_NO": {
          "type": "NUMBER",
          "nullable": false,
          "key_value": true,
          "info": "The Transmission number identifies the Transmission."
},
        "I_TRANSMISSION_REFNUM_QUAL_GID": {
          "type": "VARCHAR2(101)",
          "nullable": false,
          "key_value": true,
          "foreign_key": "I_TRANSMISSION_REFNUM_QUAL",
