...
window.HOS_DAILY_SUMMARY = {
  "tables": {
    "HOS_DAILY_SUMMARY": {
      "description": "A daily history of work time and drive time performed by a driver.",
      "columns": {
        "DRIVER_GID": {
          "type": "VARCHAR2(101)",
          "nullable": false,
        ...
        "WORK_DATE": {
          "type": "DATE",
          "nullable": false,
          "info": "Date and time to be associated with TIME_WORKED and TIME_DRIVEN fields."
},
        "SHIPMENT_GID": {
          "type": "VARCHAR2(101)",
          "nullable": true,
