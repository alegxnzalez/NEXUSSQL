    ...
    "EQUIP_AXLE_LOADING_WEIGHT": {
      "columns": {
        "EQUIPMENT_GROUP_GID": {
          ...
          "info": "The  GID for the equipment group where the axle weight is being defined.  OTM uses equipment status to indicate feasibility. The status type is AXLE_WEIGHT_FEASIBILITY and the statuses are AXLE_WEIGHT_FEASIBILITY_FEASIBLE and AXLE_WEIGHT_FEASIBILITY_INFEASIBLE respectively to indicate feasibility and infeasibility."
},
        "AXLE_SEQUENCE_NO": {
          "type": "NUMBER",
          "nullable": false,
