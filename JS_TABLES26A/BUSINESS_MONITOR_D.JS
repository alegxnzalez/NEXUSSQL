...
window.BUSINESS_MONITOR_D = {
  "tables": {
    "BUSINESS_MONITOR_D": {
      "description": "This table is used to store the specific saved queries that are defined as part of a business monitor.",
      "columns": {
        ...
        "LAYOUT_GID": {
          ...
          "info": "Transportation Workbench Layout used for this Business Monitor Detail"
}
      },
      "fk_tables": []
    }
