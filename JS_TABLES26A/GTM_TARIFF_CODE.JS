...
window.GTM_TARIFF_CODE = {
  "tables": {
    "GTM_TARIFF_CODE": {
      "description": "Captures the tariff code details.",
      "columns": {
        "DOMAIN_NAME": {
          "type": "VARCHAR2(50)",
          "nullable": false
        ...
        "PENALTY_TYPE": {
          "type": "VARCHAR2(50)",
          "nullable": true,
          "info": "Penalty type gives the type of the penalty the trade program is related to."
},
        "IS_SPLIT_ALLOWED": {
          "type": "VARCHAR2(1)",
          "nullable": false,
          ...
          "info": "This column indicates if the line with this trade program is allowed to be split."
}
      },
      "fk_tables": [
        "GTM_TARIFF_COUNTRY",
