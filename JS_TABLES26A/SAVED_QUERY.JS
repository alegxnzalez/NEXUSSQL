    ...
    "SAVED_QUERY": {
      "columns": {
        ...
        "IS_FOR_MOBILE_APP": {
          ...
          "info": "Select this field to display saved queries on the mobile application."
},
        "FIND_ALL_SQL_ID": {
          "type": "VARCHAR2(13)",
          "nullable": true,
          "info": "Find All SQL ID stored after the first time a new or modified saved query is run."
},
        "CHECK_ONE_SQL_ID": {
          "type": "VARCHAR2(13)",
          "nullable": true,
          "info": "Check One SQL ID stored after the first time a new or modified saved query is run."
},
        "COUNT_SQL_ID": {
          "type": "VARCHAR2(13)",
          "nullable": true,
          "info": "Count SQL ID stored after the first time a new or modified saved query is run for finder counts."
},
        "IS_AWR_COLLECTED": {
          "type": "VARCHAR2(1)",
          "nullable": false,
          ...
          "info": "If Y, the saved query SQL should be collected in the AWR report regardless of its performance."
}
      },
      "fk_tables": [
        "AGENT",
