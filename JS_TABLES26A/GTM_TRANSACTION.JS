...
window.GTM_TRANSACTION = {
  "tables": {
    "GTM_TRANSACTION": {
      "description": "Trade transaction. It also references a transportion object such as order release or shipment.",
      "columns": {
        "GTM_TRANSACTION_GID": {
          "type": "VARCHAR2(101)",
          "nullable": false,
        ...
        "COUNTRY_OF_EXPORT": {
          ...
          "info": "This describes the country of export for the transaction."
},
        "COUNTRY_OF_IMPORT": {
          "type": "VARCHAR2(101)",
          "nullable": true,
          "foreign_key": "COUNTRY_CODE",
          "info": "This describes the country of import for the transaction."
},
        "IS_TEMPLATE": {
          "type": "VARCHAR2(1)",
          "nullable": false,
          ...
          "info": "Checkbox indicating whether this GTM transaction or declaration record will be used as a template."
}
      },
      "fk_tables": [
        "GTM_TIP_OPERATION",
