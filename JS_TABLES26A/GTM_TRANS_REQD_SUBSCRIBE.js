// GTM_TRANS_REQD_SUBSCRIBE.js

window.GTM_TRANS_REQD_SUBSCRIBE = {
  "tables": {
    "GTM_TRANS_REQD_SUBSCRIBE": {
      "description": "A subscriber for a trade required document",
      "columns": {
        "DOMAIN_NAME": {
          "type": "VARCHAR2(50)",
          "nullable": false,
        ...
        "AS_INVOLVED_PARTY_QUAL_GID": {
          ...
          "info": "The involved party of the subscriber if they are acting as a party on the trade transaction."
}
      },
      "fk_tables": []
    }
