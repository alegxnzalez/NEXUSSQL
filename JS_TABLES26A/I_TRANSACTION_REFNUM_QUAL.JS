// I_TRANSACTION_REFNUM_QUAL.js

window.I_TRANSACTION_REFNUM_QUAL = {
  "tables": {
    "I_TRANSACTION_REFNUM_QUAL": {
      "description": "Qualifiers for Transaction reference numbers",
      "columns": {
        "I_TRANSACTION_REFNUM_QUAL_GID": {
          "type": "VARCHAR2(101)",
          "nullable": false,
          "key_value": true,
          "info": "Transaction reference number qualifier gid."
},
        "I_TRANSACTION_REFNUM_QUAL_XID": {
          "type": "VARCHAR2(50)",
          "nullable": false,
          "info": "Transaction reference number qualifier xid."
},
        "DESCRIPTION": {
          "type": "VARCHAR2(120)",
          "nullable": true,
