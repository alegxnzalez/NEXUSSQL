...
window.CONTACT = {
  "tables": {
    "CONTACT": {
      "description": "This table is used to identify a contact person at a location for communication.",
      "columns": {
        "CONTACT_GID": {
          "type": "VARCHAR2(101)",
          "nullable": false,
        ...
        "FROM_ADDR_CONTACT_GID": {
          ...
          "nullable": true,
          "foreign_key": "CONTACT",
          "info": "The GID that contains a contact's 'From-Address' details. Valid only if IS_FROM_ADDRESS is 'N'."
},
        "IS_FROM_ADDRESS": {
          "type": "VARCHAR2(1)",
          "nullable": false,
        ...
        "ALTERNATE_NAME": {
          "type": "VARCHAR2(360)",
          "nullable": true,
          "info": "If the contact goes by an alternate name the alternate name should be entered here. For example, real name Laurence Tureaud, alternate name Mr. T. Note: GTM bases restricted party screening on the party's company name. If the contact has an alternate name, the contact's alternate name is screened instead."
},
        "COMPANY_NAME": {
          "type": "VARCHAR2(360)",
          "nullable": true,
