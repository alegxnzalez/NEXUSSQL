...
window.CLAIM_LINE_ITEM_COST = {
  "tables": {
    "CLAIM_LINE_ITEM_COST": {
      "description": "Stores costs on the claim line items",
      "columns": {
        "CLAIM_GID": {
          "type": "VARCHAR2(101)",
          "nullable": false,
          ...
          "info": "The GID for the claim. Along with LINE_ITEM_SEQ_NO, this points to the claim line item to which this cost is linked."
},
        "LINE_ITEM_SEQ_NO": {
          "type": "NUMBER(9)",
          "nullable": false,
