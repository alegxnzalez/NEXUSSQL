...
window.ROUTE_CODE = {
  "tables": {
    "ROUTE_CODE": {
      "description": "Stores the source and destination information for a route (addresses and rate authority information).",
      "columns": {
        "ROUTE_CODE_GID": {
          "type": "VARCHAR2(101)",
          "nullable": false,
        ...
        "IS_UNIT_TRAIN": {
          ...
          "info": "Indicates if the route has a unit train."
},
        "ROUTE_DESCRIPTION": {
          "type": "VARCHAR2(2000)",
          "nullable": true,
