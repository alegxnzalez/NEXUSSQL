    ...
    "ML_PROJECT": {
      ...
      "columns": {
        ...
        "OBJECTIVE_MODEL_TYPE": {
          ...
          "info": "The Objective Model Type value for the machine learning Project Objective. P = Planned ETA Prediction, PE = Planned and Event Prediction, OR = Order Route Prediction and PC = Product Classification Prediction."
},
        "ML_DATA_MAPPING_GID": {
          "type": "VARCHAR2(101)",
          "nullable": true,
          "foreign_key": "ML_DATA_MAPPING",
          "info": "Machine Learning data mapping gid for this project.The will be used while loading the data to HDOWNER table"
}
      },
      "fk_tables": [
