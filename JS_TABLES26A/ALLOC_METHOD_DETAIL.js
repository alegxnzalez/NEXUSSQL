...
window.ALLOC_METHOD_DETAIL = {
  "tables": {
    "ALLOC_METHOD_DETAIL": {
      "description": "For identifying different allocation methods possible i.e. OR-W20-V80 Allocate to Order Relase by Weight 20% and Volume 80%",
      "columns": {
        "ALLOC_METHOD_GID": {
          "type": "VARCHAR2(101)",
          "nullable": false,
        ...
        "EQUIPMENT_REFERENCE_UNIT_GID": {
          ...
          "info": "The value of Equipment Reference Unit which is required to be defined when the allocation metric is ERU Count Carried Distance or ERU Count Direct Distance."
}
      },
      "fk_tables": []
    }
