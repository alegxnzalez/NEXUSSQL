// INVOICE_REFNUM_QUAL.js

window.INVOICE_REFNUM_QUAL = {
  "tables": {
    "INVOICE_REFNUM_QUAL": {
      "description": "INVOICE_REFNUM_QUAL contains the qualifier and description of additional information associated with an invoice, such as BILL OF LADING. The actual values are stored in INVOICE_REFNUM.",
      "columns": {
        ...
        "INVOICE_REFNUM_DESC": {
          "type": "VARCHAR2(120)",
          "nullable": true,
          "info": "INVOICE_REFNUM_DESC contains a description of the reference number."
},
