...
window.EMISSION_RULE = {
  "tables": {
    "EMISSION_RULE": {
      "description": "This table is used for storing the emission rule which have different emission factors with different additional attributes in the remarks. One of the emission factor which matches the emis_rule_constraint_set_gid is picked to calculate the emissions.",
      "columns": {
        "EMISSION_RULE_GID": {
          "type": "VARCHAR2(101)",
          "nullable": false,
        ...
        "EMISSION_RULE_XID": {
          "type": "VARCHAR2(50)",
          "nullable": false,
          "info": "The unique ID of an emission rule specific to a domain."
},
        "EMISSION_RULE_NAME": {
          "type": "VARCHAR2(120)",
          "nullable": true,
