...
window.S_SHIP_UNIT_LINE = {
  "tables": {
    "S_SHIP_UNIT_LINE": {
      "description": "This table stores the line item entry for each shipment ship unit entry for S_SHIP_UNIT table.",
      "columns": {
        "S_SHIP_UNIT_GID": {
          "type": "VARCHAR2(101)",
          "nullable": false,
        ...
        "LOAD_CONFIG_SETUP_GID": {
          ...
          "info": "A load configuration set up identifier to be used by the load configuration engine as the input rules during ship unit building during repack."
}
      },
      "fk_tables": [
