...
window.RATE_GEO = {
  "tables": {
    "RATE_GEO": {
      "description": "Also known as a lane, a rate geo is a prescribed course for ships, aircraft, etc. that can have costing (or time of travel) associated with it.  A rate geo may be something as general as West Coast to East Coast, country to country, state to state, or as specific as zip code to zip code.  GC3 will always look at the most granular rate_geo it can find.",
      "columns": {
        "RATE_GEO_GID": {
          "type": "VARCHAR2(101)",
          "nullable": false,
        ...
        "MULTI_BASE_GROUPS_RULE": {
          ...
          "info": "The multi base group rule determines how the results from multiple rate cost groups are evaluated. Values A/M/X. Options are: Add the Cost, Select the Least Cost, Select the Greatest Cost.  Rate Cost Groups allow you to group rate costs together.  Note: To use Rate Cost Groups, you must have rate groups active within your user preferences."
},
        ...
        "HAZARDOUS_RATE_TYPE": {
          ...
          "info": "Qualifies how the rate should be used for shipments with hazardous materials. The Hazardous Rate Type has three options which can be used to indicate whether the rate can be used for shipments with or without hazardous materials. The options are: Allows Hazardous Materials Hazardous Materials Only Non-Hazardous Materials Only"
},
        "IS_QUOTE": {
          "type": "VARCHAR2(1)",
          "nullable": false,
