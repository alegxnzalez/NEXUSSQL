// VESSEL_REFNUM_QUAL.js

window.VESSEL_REFNUM_QUAL = {
  "tables": {
    "VESSEL_REFNUM_QUAL": {
      "description": "Vessel refnum qualifiers for additional user-defined attributes of a vessel.",
      "columns": {
        "VESSEL_REFNUM_QUAL_GID": {
          "type": "VARCHAR2(101)",
          "nullable": false,
          "key_value": true,
          "info": "Vessel refnum qualifier"
},
        "VESSEL_REFNUM_QUAL_XID": {
          "type": "VARCHAR2(50)",
          "nullable": false,
          "info": "External vessel refnum qualifier"
},
        "DESCRIPTION": {
          "type": "VARCHAR2(120)",
          "nullable": true,
          "info": "Description of vessel refnum qualifier"
},
        "DEFAULT_REFNUM_BN_TYPE_GID": {
          "type": "VARCHAR2(101)",
          "nullable": true,
          "foreign_key": "BN_TYPE",
          "info": "Id for the business number generator type for this vessel refnum qualifier"
},
        "UPDATE_FLAG": {
          "type": "VARCHAR2(13)",
          "nullable": true,
