// ORDER_RELEASE_LINE_INV_PARTY.js

window.ORDER_RELEASE_LINE_INV_PARTY = {
  "tables": {
    "ORDER_RELEASE_LINE_INV_PARTY": {
      "description": "Holds involved parties linked to order release lines",
      "columns": {
        "ORDER_RELEASE_LINE_GID": {
          ...
          "info": "The GID for the order release line to which the involved party is linked."
},
