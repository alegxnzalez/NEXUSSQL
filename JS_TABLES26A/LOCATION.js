...
window.LOCATION = {
  "tables": {
    "LOCATION": {
      "description": "A Location is a place where transportation related activities occur, such as loading and unloading freight. In addition, a location may represent a corporation, and/or a service provider.",
      "columns": {
        "LOCATION_GID": {
          "type": "VARCHAR2(101)",
          "nullable": false,
        ...
        "EQUIPMENT_GROUP_PROFILE_GID": {
          ...
          "info": "The GID for the equipment group profile. An Equipment Group Profile is used to categorize Equipment groups by some common attribute or grouping scheme. For example, you can create a Group Profile called Dry Vans that include the 28 FT Dry Van and 24 FT Dry Van (and others if you like) Equipment Groups. An Equipment Group Profile consists of an ID and a Profile Name and a collection of specific Equipment Groups that you associate with the profile. Oracle Transportation Management can use the Profile in planning to limit the Equipment Groups that can be used for shipment planning. When Oracle Transportation Management bundles orders and builds shipments, it checks that there is an intersection between the equipment group values identified on the order bases. Example: Equipment Group Rule"
},
        "SLOT_TIME_INTERVAL": {
          "type": "NUMBER",
          "nullable": true,
        ...
        "PRIMARY_ADDRESS_LINE_SEQ": {
          "type": "NUMBER(10)",
          "nullable": false,
          "info": "The Address Line Number or primary address line sequence number designates which line of the address text box contains the actual street address so when using the External Distance Engine, the correct street address is used.  For example, if you had this address in the text box, the line number would be 2. Care of Someone 1234 Main St."
},
        "DOMAIN_NAME": {
          "type": "VARCHAR2(50)",
          "nullable": false,
        ...
        "SHUTTLE_LOT_EQ_GRP_PROFILE_GID": {
          "type": "VARCHAR2(101)",
          "nullable": true,
          "foreign_key": "EQUIPMENT_GROUP_PROFILE",
          "info": "This specifies the equipment group profile for the shuttle or parking lot of a location. When a shipment uses one of the equipment groups in this equipment group profile, the location cannot be directly accessed for pickup/delivery and is accessed only through the shuttle lot. In this case, additional shuttle lot activity time is computed and added to the activity time at the location."
},
        "IS_WMS_FACILITY": {
          "type": "VARCHAR2(1)",
          "nullable": false,
          ...
          "info": "Indicates if the location is a warehouse management system facility."
},
        "ERU_GROUPING": {
          "type": "VARCHAR2(101)",
          "nullable": true,
          "info": "To indicate orders going to this location will be grouped together for ERU grouping."
},
        "APPT_ENFORCE_ACT_TIME_SG": {
          "type": "VARCHAR2(1)",
          "nullable": false,
          "values": [
                    "Y",
          ...
          "info": "Enforce Activity Time for shipment group appointments."
},
        "ADDRESS_VALIDATION_EDE": {
          "type": "VARCHAR2(150)",
          "nullable": true,
          "foreign_key": "DISTANCE_EXTERNAL_ENGINE",
          "info": "Indicates which external distance engine is used to validate the location."
},
        "OVERALL_QUALITY": {
          "type": "VARCHAR2(150)",
          "nullable": true,
          "info": "Indicates the overall quality of the location."
},
        "HAS_MULTIPLE_MATCHES": {
          ...
          "info": "Indicates if we have multiple matches for the location after address validation."
},
        "APPT_CUTOFF_HOURS": {
          "type": "NUMBER",
          "nullable": true,
          "info": "Service provider appointment cutoff in hours."
},
        "APPT_BEFORE_CUTOFF": {
          "type": "NUMBER",
          "nullable": true,
          "info": "Service provider appointment duration before cutoff."
},
        "APPT_BEFORE_CUTOFF_BASE": {
          "type": "NUMBER",
          "nullable": true,
          "info": "The service provider appointment duration before cutoff in the base unit of measure."
},
        "APPT_BEFORE_CUTOFF_UOM_CODE": {
          "type": "VARCHAR2(64)",
          "nullable": true,
          "info": "Unit of meassure for the service provider appointment duration before cutoff."
},
        "APPT_AFTER_CUTOFF": {
          "type": "NUMBER",
          "nullable": true,
          "info": "Service provider appointment duration after cutoff."
},
        "APPT_AFTER_CUTOFF_BASE": {
          "type": "NUMBER",
          "nullable": true,
          "info": "The service provider appointment duration after cutoff in the base unit of measure."
},
        "APPT_AFTER_CUTOFF_UOM_CODE": {
          "type": "VARCHAR2(64)",
          "nullable": true,
          "info": "Unit of meassure for the service provider appointment duration after cutoff."
},
        "APPT_START_TIME_TOLERANCE_SECS": {
          "type": "NUMBER",
          "nullable": true,
          "info": "Stores tolerance value for appointment start time in seconds."
},
        "ATTRIBUTE_DATE11": {
          "type": "DATE",
          "nullable": true,
