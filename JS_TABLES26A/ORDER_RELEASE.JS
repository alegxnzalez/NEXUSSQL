...
window.ORDER_RELEASE = {
  "tables": {
    "ORDER_RELEASE": {
      "description": "The early sailing date and time to be used as a constraint when planning the order release onto a buy shipment on the primary leg. This constraint only applies when the primary leg contains a voyage.",
      "columns": {
        "ORDER_RELEASE_GID": {
          "type": "VARCHAR2(101)",
          "nullable": false,
        ...
        "EXTERNAL_VOYAGE_CODE": {
          "type": "VARCHAR2(80)",
          "nullable": true,
          "info": "Specifies the number of the voyage as assigned by the carrier.After the voyages are queried from an external voyage service and the user selects a particular voyage result,the voyage number selected for this result will be saved in this column.             This will be used while planning the order for a shipment."
},
        "IS_DIRECT_VOYAGE": {
          "type": "VARCHAR2(1)",
          "nullable": true,
          ...
          "info": "The flag indicates whether only direct voyages, that is voyages without trans-shipments should be retrieved by an external voyage service.             It will be used for querying the voyage based on data from order release."
},
        "PREDICTED_ORDER_ROUTE": {
          "type": "VARCHAR2(2000)",
          "nullable": true,
          "info": "Stores the predicted order route path."
}
      },
      "fk_tables": [
        "ALLOCATION",
