...
window.REPORT_SYSTEM = {
  "tables": {
    "REPORT_SYSTEM": {
      "description": "Definition of an external report generation system",
      "columns": {
        "REPORT_SYSTEM_GID": {
          "type": "VARCHAR2(101)",
          "nullable": false,
        ...
        "EXTERNAL_SYSTEM_GID": {
          ...
          "info": "The external system that specifies the REST-based web service for connecting to an external report service."
}
      },
      "fk_tables": [
        "IPP_PRINTER",
