// BULK_PLAN_MILESTONE.js

window.BULK_PLAN_MILESTONE = {
  "tables": {
    "BULK_PLAN_MILESTONE": {
      "columns": {
        "BULK_PLAN_MILESTONE_SEQ": {
          ...
          "nullable": false,
          "key_value": true,
          "info": "A globally unique ID for this bulk plan milestone"
},
        "BULK_PLAN_GID": {
          "type": "VARCHAR2(101)",
          "nullable": false,
        ...
        "PLANNING_MILESTONE_GID": {
          ...
          "info": "Planning milestone type (e.g. Order Bundling)"
},
        ...
        "ALGORITHM": {
          "type": "VARCHAR2(300)",
          "nullable": true,
          "info": "Algorithmic choice (e.g. 2-opt, DP)"
},
        "NUM_THREADS": {
          "type": "NUMBER(3)",
          "nullable": true,
        ...
        "PROGRESS_DESCRIPTION": {
          "type": "VARCHAR2(100)",
          "nullable": true,
          "info": "A text description to place after 'xx of yy'. E.g. 'orders processed'"
},
        "PARTITION_GID": {
          "type": "VARCHAR2(101)",
          "nullable": true,
          "info": "If part of a bulk plan partition, the partition ID"
},
        "LOG_PROCESS_ID": {
          "type": "NUMBER",
          "nullable": true,
