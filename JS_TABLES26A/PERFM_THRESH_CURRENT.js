...
window.PERFM_THRESH_CURRENT = {
  "tables": {
    "PERFM_THRESH_CURRENT": {
      "description": "A current metric alert threshold",
      "columns": {
        ...
        "THRESHOLD_VALUE": {
          "type": "NUMBER",
          "nullable": false,
          "info": "If HIST_COMPARISON_GID is null, the value that has to be exceeded for the alert to trigger. Otherwise, a multiplier on the historical comparison statistic to trigger the alert."
},
        "HIST_COMPARISON_GID": {
          "type": "VARCHAR2(101)",
          "nullable": true,
