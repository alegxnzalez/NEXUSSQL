...
window.P_SHIPMENT = {
  "tables": {
    "P_SHIPMENT": {
      "description": "Procurement shipment - a light weight version of the gc3 shipment with minimal information",
      "columns": {
        "P_SHIPMENT_GID": {
          "type": "VARCHAR2(101)",
          "nullable": false,
        ...
        "EQUIPMENT_REFERENCE_UNIT_GID": {
          ...
          "info": "The Equipment Reference Unit GID is assosiated with the Equipment Reference unit utilization of the shipment."
},
        "TOTAL_NUM_REFERENCE_UNITS": {
          "type": "NUMBER",
          "nullable": true,
          "info": "The total number of reference units of the shipment is defined by the equipment reference units."
}
      },
      "fk_tables": [
