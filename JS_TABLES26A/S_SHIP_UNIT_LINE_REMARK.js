// S_SHIP_UNIT_LINE_REMARK.js

window.S_SHIP_UNIT_LINE_REMARK = {
  "tables": {
    "S_SHIP_UNIT_LINE_REMARK": {
      "description": "This table stores the additional remarks at the line item level for the shipment ship unit.",
      "columns": {
        "S_SHIP_UNIT_GID": {
          "type": "VARCHAR2(101)",
          "nullable": false,
        ...
        "S_SHIP_UNIT_LINE_NO": {
          ...
          "key_value": true,
          "foreign_key": "S_SHIP_UNIT_LINE",
          "info": "The shipment ship unit line number sequence."
},
        "REMARK_SEQUENCE": {
          "type": "NUMBER",
          "nullable": false,
