...
window.PARTNER_ITEM = {
  "tables": {
    "PARTNER_ITEM": {
      "description": "This table contains the Partner item details",
      "columns": {
        "DOMAIN_NAME": {
          "type": "VARCHAR2(50)",
          "nullable": false
        ...
        "PARTNER_TYPE": {
          ...
          "info": "Specifies partner type for the external party. It can be 'S' for supplier or 'C' for customer or 'M' for manufacturer."
},
        "PARTNER_GID": {
          "type": "VARCHAR2(101)",
          "nullable": false,
