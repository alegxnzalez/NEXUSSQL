    ...
    "RATE_GEO_COST_OPERAND": {
      ...
      "columns": {
        ...
        "REST_ATTRIBUTE_NAME": {
          "type": "VARCHAR2(101)",
          "nullable": true,
          "info": "Specifies the rest attribute name for the rate record cost operand. This name will be used as the key in the JSON request when invoking the external engine."
}
      },
      "fk_tables": [
        "ACCESSORIAL_COST",
