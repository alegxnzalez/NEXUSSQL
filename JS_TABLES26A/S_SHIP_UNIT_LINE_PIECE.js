// S_SHIP_UNIT_LINE_PIECE.js

window.S_SHIP_UNIT_LINE_PIECE = {
  "tables": {
    "S_SHIP_UNIT_LINE_PIECE": {
      "columns": {
        "DOMAIN_NAME": {
          "type": "VARCHAR2(50)",
          "nullable": false
        ...
        "PIECE_NUMBER": {
          ...
          "nullable": false,
          "key_value": true,
          "info": "A unique number given to a piece of shipment ship unit line having the same S_SHIP_UNIT_GID and S_SHIP_UNIT_LINE_NO with multiple counts."
},
        "LOADING_SEQUENCE": {
          "type": "NUMBER",
          "nullable": false,
          "info": "The loading sequence of the shipment ship unit line piece."
},
        "STACKING_LAYER": {
          "type": "NUMBER",
          "nullable": true,
        ...
        "ORIENTATION_GID": {
          ...
          "info": "Orientation of the shipment ship unit line piece."
},
        "X_COORDINATE": {
          "type": "NUMBER",
          "nullable": false,
