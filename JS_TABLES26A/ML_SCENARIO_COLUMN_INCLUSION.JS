    ...
    "ML_SCENARIO_COLUMN_INCLUSION": {
      "columns": {
        ...
        "EXCLUSION_TYPE": {
          ...
          "info": "The Exclusion Type value for the machine learning exclude columns are PES= Planning ETA - Shipment,EES= Execution ETA - Shipment, EEE =   Execution ETA - Event, OR = Order Route, and PC = Product Classification."
},
        "IS_EXCLUDED": {
          "type": "VARCHAR2(1)",
          "nullable": false,
