    ...
    "RATE_GEO_COST": {
      "columns": {
        ...
        "CHARGE_TYPE": {
          ...
          "info": "There are the following cost types:\nCharge\nDiscount\nExternal\nProfile "
        },
        "CHARGE_MULTIPLIER_OPTION": {
          ...
          "info": "Controls how charge multipliers are applied against the specified cost. Values (A/L/S/G/E/I). There are a set of options: \nAdd individual multiplier values\nGreatest individual cost\nChoose lowest individual cost\nCollect costs separately "
        },
        "CHARGE_MULTIPLIER2": {
          "type": "VARCHAR2(101)",
          "nullable": true,
