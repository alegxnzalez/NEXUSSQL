    ...
    "DOMAIN_SETTING": {
      "columns": {
        ...
        "IS_PURGE_ONLY": {
          ...
          "info": "A Y/N indicator to define archiving of the purged business data. Y indicates that purged data does not get archived. N (default) indicates that purged data gets archived."
        }
      },
      "fk_tables": [
