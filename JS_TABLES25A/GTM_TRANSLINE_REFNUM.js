// GTM_TRANSLINE_REFNUM.js

window.GTM_TRANSLINE_REFNUM = {
  "tables": {
    "GTM_TRANSLINE_REFNUM": {
      "columns": {
        ...
        "GTM_TRANSLINE_REFNUM_QUAL_GID": {
          ...
          "nullable": false,
          "key_value": true,
          "foreign_key": "GTM_TRANSLINE_REFNUM_QUAL",
          "info": "The GID for the GTM trade transaction line reference number qualifier. "
        },
        "REFNUM_VALUE": {
          "type": "VARCHAR2(240)",
          "nullable": false,
