// ORDER_RELEASE_LINE_REFNUM_QUAL.js

window.ORDER_RELEASE_LINE_REFNUM_QUAL = {
  "tables": {
    "ORDER_RELEASE_LINE_REFNUM_QUAL": {
      "columns": {
        ...
        "OR_LINE_REFNUM_SEQUENCE_NO": {
          "type": "NUMBER(10)",
          "nullable": true,
          "info": "The sequence number for Refnum Qualifier, to determine the sequence of Refnum Qualifiers on the Order Release Line Manager."
        },
        "DOMAIN_NAME": {
          "type": "VARCHAR2(50)",
          "nullable": false
