    ...
    "CM_RULE": {
      "columns": {
        ...
        "MAX_REL_EMPTY_DISTANCE": {
          "type": "NUMBER(5,2)",
          "nullable": true,
          "info": "Max Empty Distance (%) is used to disqualify shipments that are too short in comparison to the distance travelled to include the shipment in the continuous move tour.\nMax Empty Distance (%) = 100*E/L, where\nE = Max Empty Distance\nL = Line Haul Distance of the shipment "
        },
